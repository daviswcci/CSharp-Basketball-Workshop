...
namespace Basketball_Workshop.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public PositionsController(BasketballContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Positions != null ? 
                          ...
                          Problem("Entity set 'BasketballContext.Positions'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BasketballContext.Positions'  is null.");
            }
            var position = await _context.Positions.FindAsync(id);
            if (position != null)
            {
